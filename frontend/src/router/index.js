...
const routes = [
  ...
  { path: '/store/:serial', name: 'public-store', component: moduleView, meta: { title: 'Tienda pública' } },
  { path: '/store/:serial/product/:productId', name: 'public-product', component: moduleView, meta: { title: 'Producto' } },
  { path: '/store/:serial/cart', name: 'public-cart', component: moduleView, meta: { title: 'Carrito' } },
  { path: '/store/:serial/checkout', name: 'public-checkout', component: moduleView, meta: { title: 'Finalizar compra' } },
  { path: '/store/:serial/thanks', name: 'public-thanks', component: moduleView, meta: { title: 'Pedido recibido' } },
