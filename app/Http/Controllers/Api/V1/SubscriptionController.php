...
class SubscriptionController extends Controller
{
    ...
    public function createAllSubscriptions(Request $request)
    {
        ...
        if (! $plan) {
            return response()->json(['message' => 'No hay plan gratuito configurado.'], 422);
        }
    ...
    public function mySubscription(Request $request)
    {
        ...
        return response()->json(['data' => [
            ...
            'current_products' => Product::byStore($store->createdby)->count(),
    ...
    public function checkModule(Request $request)
    {
        ...
        if (! $sub) {
            return response()->json(['access' => false, 'message' => 'Sin suscripcion activa']);
        }
